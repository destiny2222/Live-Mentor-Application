...
<!-- ROW-1 OPEN -->
@if($profile->role == 'mentor' ||  $profile->role == 'tutor')
                                ...
                                <div class="panel profile-cover">
                                    ...
                                    <div class="profile-cover__img">
                                        <div class="profile-img-1">
                                            <img src="{{ asset('profile/'.$profile->image) }}" alt="img">
                                        </div>
                                        ...
                                        <div class="mt-3">
                                            @if($profile->role == 'tutor' ||  $profile->role == 'mentor')
                                                <div class="share-buttons text-lg-end">
                                                    <a class="social-icon text-primary" href="{{ $shareButtons->getRawLinks()['facebook'] }}" target="_blank">
                                                        <i class="fa fa-facebook"></i>
                                                    </a>
                                                    <a class="social-icon text-primary" href="{{ $shareButtons->getRawLinks()['twitter'] }}" target="_blank">
                                                        <i class="fa fa-twitter"></i>
                                                    </a>
                                                    <a class="social-icon text-primary" href="{{ $shareButtons->getRawLinks()['linkedin'] }}" target="_blank">
                                                        <i class="fa fa-linkedin"></i>
                                                    </a>
                                                    <a class="social-icon text-primary" href="{{ $shareButtons->getRawLinks()['whatsapp'] }}" target="_blank">
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center" style="justify-content: space-between;">
                            ...
                            <div class="text-lg-end text-sm-start">
                                <a  class="btn btn-primary" href="{{ route('edit.profile.index') }}">Edit</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tags">
                            @if($profile->role == 'tutor')
                                @if (!empty($profile->tutor) && !empty($profile->tutor->skills))
                                    @foreach ($profile->tutor->skills as $skill)
                                        <a href="javascript:void(0)" class="tag">{{ $skill }}</a>
                                    @endforeach
                                @endif
                            @elseif ($profile->role == 'mentor')
                                @if (!empty($profile->mentor) && !empty($profile->mentor->skills))
                                    @foreach ($profile->mentor->skills as $skill)
                                        <a href="javascript:void(0)" class="tag">{{ $skill }}</a>
                                    @endforeach
                                @endif
                            @endif
                                    ...
                                    <div class="me-5">
                                        <div class="media mb-4 d-flex">
                                            ...
                                            <div class="media-body">
                                                <h6 class="font-weight-semibold mb-1">{{ $certifications->title }} at <a href="javascript:void(0)" class="btn-link">{{ $certifications->company }}</a></h6>
                                                <span>
                                                    {{ $certifications->date ? $certifications->date->format('Y') : 'N/A' }} - 
                                                    {{ $certifications->end_date ? $certifications->end_date->format('Y') : 'N/A' }}
                                                </span>
                                                <p>{{ \Str::limit($certifications->description, 100)}}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach 
                                ...
                                @foreach ($profile->education as $educations)
                                    <div class="me-5">
                                        <div class="media mb-4 d-flex">
                                            ...
                                            <div class="media-body">
                                                <h6 class="font-weight-semibold mb-1">{{ $educations->degree }} at <a href="javascript:void(0)" class="btn-link">{{ $educations->school }}</a></h6>
                                                <span>
                                                    {{ $educations->start_date ? $educations->start_date->format('Y') : 'N/A' }} - 
                                                    <span class="year">{{ $educations->end_date ? $educations->end_date->format('Y') : 'N/A' }}</span>
                                                </span>
                                                <p>{{ \Str::limit($educations->description, 100)}}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach 
