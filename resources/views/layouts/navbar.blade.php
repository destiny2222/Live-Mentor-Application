...
<ul id="myDropdown" class="dropdown-content">
    ...
    <li class="active"><a href="{{ route('dashboard') }}"><i class="flaticon-home mr10"></i>Dashboard</a></li>
    ...
    @endif
    <li><a href="{{ route('profile.index') }}"><i class="flaticon-photo mr10"></i>My Profile</a></li>
