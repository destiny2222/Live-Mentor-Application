              ...
              <div class="tab-pane fade show active" id="nav-item1" role="tabpanel" aria-labelledby="nav-item1-tab">
                <div class="row">
                  ...
                  <div class="col-sm-6 col-xl-4">
                    <div class="listing-style1">
                      <div class="list-thumb">
                        ...
                        <a href="{{ route('course.details', $course->slug) }}" class="tag-del" data-bs-toggle="tooltip"
                          data-bs-placement="top" title="" data-bs-original-title="Delete Item"
                  ...
                  <div class="col-sm-12 col-xl-12">
                    <p>Empty Course <a href="{{ route('course.index') }}" class="btn btn-primary text-white"
                        target="_blank" rel="noopener noreferrer">Add Course</a></p>
                  </div>
                  @endforelse
